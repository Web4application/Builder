...
addRPMSig(an_rpm, data, sigkey=None)
...
chainMaven(builds, target, opts=None, priority=None, channel=None)
...
flatpakBuild(src, target, opts=None, priority=None, channel=None)
  Create a build task for a Flatpak
...
flatpakSetExtra(task_id, build_id, build_extra, archive_extra)
  set image data for Flatpak result
...
getRPMHeaders(rpmID=None, taskID=None, filepath=None, headers=None, strict=False, sigkey=None)
...
imageBuilderBuild(target, arches, types, name, version, opts=None, priority=None)
...
importRPM(path, basename, sigkey=None)
  Import an RPM into the database.

The file must be uploaded first.

     
kiwiBuild(target, arches, desc_url, desc_path, optional_arches=None, profile=None, scratch=False, priority=None, make_prep=False, repos=None, release=None, type=None, type_attr=None, result_bundle_name_format=None, use_buildroot_repo=False, version=None, repo_releasever=None)
...
listBuilds(packageID=None, userID=None, taskID=None, prefix=None, state=None, volumeID=None, source=None, createdBefore=None, createdAfter=None, completeBefore=None, completeAfter=None, type=None, typeInfo=None, queryOpts=None, pattern=None, cgID=None, draft=None, promotedBefore=None, promotedAfter=None, promoter=None)
...
mavenBuild(url, target, opts=None, priority=None, channel=None)
...
renameRPMSig(rpminfo, oldkey, newkey)
...
repo.request(tag, min_event=None, at_event=None, opts=None, priority=None, force=False, lag=None)
...
winBuild(vm, url, target, opts=None, priority=None, channel=None)
...
wrapperRPM(build, url, target, priority=None, channel=None, opts=None)
